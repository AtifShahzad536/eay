...
const LeftPanel = ({
  ...
  return (
    <div className="flex-shrink-0 md:flex-1 flex flex-col md:flex-row h-[50vh] md:h-full relative bg-white overflow-hidden">
      {/* ── Dynamic Mesh Toolbar ── */}
      <div className="w-full h-14 md:w-24 md:h-full flex md:flex-col items-center bg-[#f5f5f5] border-b md:border-r border-[#e0e0e0] py-1 md:py-2 flex-shrink-0 overflow-x-auto md:overflow-y-auto right-scroll" data-lenis-prevent>
